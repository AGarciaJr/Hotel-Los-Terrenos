    ...
    return (
        <div className="vacation-container">
            ...
            <div className="vacation-buttons">
                ...
                <div className="vacation-item" onClick={() => handleVacationClick("/vacations/club")}>
                ...
                <div className="vacation-item" onClick={() => handleVacationClick("/vacations/chinese-restaurant")}>
                ...
                <div className="vacation-item" onClick={() => handleVacationClick("/vacations/casino")}>
